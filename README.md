...
- [`MODEL_CARD.md`](MODEL_CARD.md) — the model card, written against the DIMER Model Card
  Specification at the version its front matter declares (intended uses and users,
  out-of-scope uses, factors, metrics and decision thresholds, ethical considerations);
